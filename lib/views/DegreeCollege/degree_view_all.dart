...
class DegreeAllStudentsView extends StatefulWidget {
  const DegreeAllStudentsView({Key? key}) : super(key: key);

  @override
  _DegreeAllStudentsViewState createState() => _DegreeAllStudentsViewState();
}

class _DegreeAllStudentsViewState extends State<DegreeAllStudentsView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
          stream: db
              .collection("Students")
              .where('Section', isEqualTo: 'Degree Section')
              .snapshots(),
