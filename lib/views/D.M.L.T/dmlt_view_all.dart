...
class DMLTAllStudentsView extends StatefulWidget {
  const DMLTAllStudentsView({Key? key}) : super(key: key);

  @override
  _DMLTAllStudentsViewState createState() => _DMLTAllStudentsViewState();
}

class _DMLTAllStudentsViewState extends State<DMLTAllStudentsView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
          stream: db
              .collection("Students")
              .where('Section', isEqualTo: 'D.M.L.T')
              .snapshots(),
