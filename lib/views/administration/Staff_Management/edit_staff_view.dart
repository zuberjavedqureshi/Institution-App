import 'package:auster_education/crud%20management/update_staff.dart';
            ...
            IconButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => UpdateStaffView(
                            sImage: widget.sImage,
                            sId: widget.sId,
                            sSalary: widget.sSalary,
                            sPhoneNumber: widget.sPhoneNumber,
                            sAdress: widget.sAdress,
                            sDegisnation: widget.sDegisnation,
                            sName: widget.sName,
                            sDoa: widget.sDoa,
                          )));
                },
                    ...
                    child: Column(
                      ...
                      children: [
                        Align(
                          ...
                          child: Text("Staff Id: ${widget.sId}"),
                        ),
                        SizedBox(
                          height: 10,
                        ),
                        Align(
                          alignment: Alignment.bottomLeft,
                          child: Text("Degisnation: ${widget.sDegisnation}"),
                        ),
                        SizedBox(
                          height: 10,
                        ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Align(
                          alignment: Alignment.bottomLeft,
                          child: Text("Montly Salary: ₹${widget.sSalary}"),
                        ),
                        SizedBox(
                          height: 10,
                        ),
